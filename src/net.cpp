...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "aquacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"aquacointools.com", "dnsseed.aquacointools.com"},
    {"aquacoinpool.org", "dnsseed.aquacoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"aquacointools.com", "testnet-seed.aquacointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. aquacoin is probably already running."), addrBind.ToString().c_str());
        else
